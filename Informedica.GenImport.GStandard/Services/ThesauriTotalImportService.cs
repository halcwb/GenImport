...
{
    public class ThesauriTotalGStandardImportService : GStandardImportServiceBase<IThesauriTotal>
    {


        #region Overrides of GStandardImportServiceBase<IThesauriTotal>

        public ThesauriTotalGStandardImportService(string databaseFilePath, IFileSerializer<IThesauriTotal> fileSerializer, IRepository<IThesauriTotal> repository)
