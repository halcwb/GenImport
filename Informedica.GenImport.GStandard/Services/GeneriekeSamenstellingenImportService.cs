...
{
    public class GeneriekeSamenstellingenImportService : GStandardImportServiceBase<IGeneriekeSamenstelling>
    {
        public GeneriekeSamenstellingenImportService(string databaseFilePath, IFileSerializerBase<IGeneriekeSamenstelling> fileSerializer, ISessionFactory sessionFactory)
        ...
        public override void Import(Stream stream)
        {
            ...
            ProcessFile(stream, FileSerializer, n => query.SetInt32("GsKode", n.GsKode)
