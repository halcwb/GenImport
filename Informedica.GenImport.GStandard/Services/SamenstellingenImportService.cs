        ...
        public override void Import(Stream stream)
        {
            var query =
                CurrentSession.CreateSQLQuery(
                    "INSERT INTO Samenstelling (MutKod, ThsrTc, Code, SrtCde, GnGnK, GnHoev, TsGneH, GnEenh, GnStam, StHoev, TsStEh, StEenh, StAdd) VALUES (:MutKod, :ThsrTc, :Code, :SrtCde, :GnGnK, :GnHoev, :TsGneH, :GnEenh, :GnStam, :StHoev, :TsStEh, :StEenh, :StAdd)");
