...
{
    [TestClass]
    public class CommercialProductMapShould : TestSessionContext
    {
        [TestMethod]
        public void Correctly_Map_CommercialProduct()
        {
            new PersistenceSpecification<CommercialProduct>(CurrentSession)
