...
{
    [TestClass]
    public class GeneriekeSamenstellingShould
    {
        ...
        public void Have_A_LinePositionAttribute_On_7_Known_Properties()
        {
            ...
            Assert.IsTrue(AttributeTestUtility.HasAttributeCount<GeneriekeSamenstelling, FileLinePositionAttribute>(expectedCount));
        }

        [TestMethod]
        public void Have_A_Valid_LinePositionAttribute_On_MutKod_Property_With_Position_5_5()
        {
            var info = ReflectionUtility.GetMemberInfo(() => new GeneriekeSamenstelling().MutKod);
        ...
        {
            var info = ReflectionUtility.GetMemberInfo(() => new GeneriekeSamenstelling().GnMwHs);
        ...
        {
            var info = ReflectionUtility.GetMemberInfo(() => new GeneriekeSamenstelling().GsKode);
        ...
        {
            var info = ReflectionUtility.GetMemberInfo(() => new GeneriekeSamenstelling().GnNkPk);
        ...
        {
            var info = ReflectionUtility.GetMemberInfo(() => new GeneriekeSamenstelling().GnMomH);
        ...
        {
            var info = ReflectionUtility.GetMemberInfo(() => new GeneriekeSamenstelling().XnMomE);
        ...
        {
            var info = ReflectionUtility.GetMemberInfo(() => new GeneriekeSamenstelling().XpEhHv);
        ...
        public void Have_A_Modulo11Attribute_On_2_Properties()
        {
            ...
            Assert.IsTrue(AttributeTestUtility.HasAttributeCount<GeneriekeSamenstelling, Modulo11Attribute>(expectedCount));
        }
        ...
        public void Have_A_ConvertToDecimalAttribute_On_1_Property()
        {
            ...
            Assert.IsTrue(AttributeTestUtility.HasAttributeCount<GeneriekeSamenstelling, DecimalFormatAttribute>(expectedCount));
        }
