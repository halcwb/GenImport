...
namespace Informedica.GenImport.GStandard.Tests.Services
{
    ...
    public class NameImportServiceShould : TestSessionContext
    {
        ...
        private class ImportServiceMock : NameImportService
        {
            public ImportServiceMock(string databasePath, IFileSerializerBase<IName> fileSerializer, ISessionFactory sessionFactory)
        ...
        public void Import_The_Name_From_A_Stream_And_Create_An_Entity_In_The_Database()
        {
            ...
            var fileSerializerMock = new Mock<IFileSerializerBase<IName>>(MockBehavior.Strict);
            ...
            Assert.AreEqual(expectedCount, new NameRepository(sessionFactory).Count);
        }
    }
}
